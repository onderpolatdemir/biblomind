...
Usage: python scripts/index_books_to_es.py
"""
...
def main():
    ...
    try:
        ...
        if book_count == 0:
            ...
            print("    Run seed_books.py first to populate data.")
            return False
        ...
        if result['failure'] == 0:
            ...
            print(f"  PARTIAL SUCCESS! {result['failure']} books failed to index")
        print("="*60 + "\n")
        
        print("Next steps:")
        print("1. Test search in Swagger UI: http://localhost:8000/docs")
        print("2. Try: GET /api/books/search?q=1984")
        print("3. Test fuzzy: GET /api/books/search?q=Orwel")
        print("4. Test filters: GET /api/books/search?q=fiction&genre=Science Fiction")
        print()
