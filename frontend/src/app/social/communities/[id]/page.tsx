...
import { Users, Lock, Globe, Settings, X } from "lucide-react";
                        ...
                        <div className="px-6 pb-6">
                            <div className="flex items-end gap-4 -mt-10 mb-4">
                                ...
                                <div className="flex items-center gap-2 flex-shrink-0 pb-1">
                                    {(community.is_creator || community.user_role === "admin") && (
                                        <button
                                            onClick={() => router.push(`/social/communities/create?edit=${id}`)}
                            ...
                            {community.privacy === "private" && !community.is_member ? (
                                ...
                                <>
                                    ...
                                    {postsLoading ? (
                                        ...
                                        posts.map((post) => <PostCard key={post.id} post={post} onDelete={deletePost} onImageClick={(src) => setLightboxSrc(src)} />)
                                    )}
                                </>
                            )}
                        </motion.div>
